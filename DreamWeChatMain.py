        ...
        if '_' in we_chat_msg_content:
            ...
            if len(msg_content) >= 2:
                ...
                # 删除梦想
                    ...
                    return delete_dream_name(msg_content)
                # 修改梦想
                elif op == 'M' or op == 'm':
                    return modify_dream(msg_content)
                # 查询梦想
                elif op == 'Q' or op == 'q':

                    return query_dream(msg_content)
                # 完成梦想
                elif op == 'F' or op == 'f':
                    return finish_dream(msg_content)
        else:
...
# 删除梦想
def delete_dream_name(msg_content):
    if len(msg_content) >= 2:
